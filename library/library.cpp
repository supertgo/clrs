...
void status() {
  register int i;
  cout << "Library has the follwing books:\n\n";
...
void returnBook() {
  ...
  while (true) {
    ...
    if (patronRef == people[patron.name[0]])
...
int menu() {
  ...
  cout << "\nEnter one of the following options:\n"
    << "1. Include a book in the catalog\2. Check ou at book\n"
    << "3. Return a book\n4. Status\n5. Exit\n"
    << "Your option? ";
